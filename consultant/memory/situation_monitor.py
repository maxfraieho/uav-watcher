...
Визнач рівень ПОТОЧНОЇ загрози для міста {city} ({region}):
РІВЕНЬ 0 — Загроз немає (відбій, тиша, тривоги тільки в далеких регіонах)
РІВЕНЬ 1 — Спостереження (БПЛА або ракети зафіксовано в регіоні або на підльоті, тривога НЕ оголошена для {city})
РІВЕНЬ 2 — Тривога (оголошена повітряна тривога в районі {city}, або БПЛА/ракети рухаються в бік {city})
РІВЕНЬ 3 — Небезпека (БПЛА або ракети безпосередньо над {city}, або вибухи в місті / поруч з містом)
