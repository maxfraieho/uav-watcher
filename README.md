...
> 🚧 **Статус: активна розробка.** Функціонал може бути нестабільним.

> ⚠️ **Відмова від відповідальності:** Система є доповненням до офіційного оповіщення ДСНС, не його заміною. AI може помилятись — як і будь-яка мовна модель. Розробники не несуть відповідальності за рішення на основі даних системи. При сигналі тривоги — прямуйте до укриття.
